  ...
  return (
    ...
    <div className="absolute z-20 left-1/2 -translate-x-1/2 bottom-[15vh] md:left-auto md:right-[-5vw] md:bottom-[10vh] md:translate-x-0 flex items-center justify-center md:w-auto">
      ...
      <div className="relative -ml-[10%]">
        ...
        >
          <span className="text-white absolute bottom-[15%] left-[20%] text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold font-['FK_Screamer_Trial'] whitespace-nowrap">
            {daysToGo} DAYS TO GO!!
          </span>
        </div>
      </div>
